...
abstract class RemoteService {
  ...
  // Future<AccessToken?> accessTokenTest(String userName, String password);
  Future<SaleVoucherVM?> createSaleVoucher(SaleVoucherVM saleVoucher);
  ...
  Future<int?> createTransferVoucher(TransferVoucherVM transferVo);
  ...
  Future<List<SaleVoucherDetailVM>?> getSaleVoucherDetail(String saleVoucherNo);
